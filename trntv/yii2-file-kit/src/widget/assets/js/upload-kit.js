...
(function( $ ) {
    jQuery.fn.yiiUploadKit = function(options) {
        ...
        var methods = {
            ...
            sizeImg: function GetOrigSize () {
            var image = document.getElementById ("t2");
                    ...
                    progressall: function (e, data) {
                        ...
                        $.each(data.result.files, function (index, file) {
                            if (!file.error) {
                                ...
                                item.appendTo($files);
                                 // console.log($('#t2').eq(1)[0].namespaceURI);
                            ...
                            //Код определяющий размеры загружаемого изображения,  если есть инпуты высоты и ширины
                            ...
                            // if($('#affiliatepromotion-width').length > 0)
                            // {
                            //     var img = $("#t2")[0]; // Get my img elem
                            //     var pic_real_width, pic_real_height;
                            //     $("<img/>") // Make in memory copy of image to avoid css issues
                            ...
                            //             pic_real_width = this.width;   // Note: $(this).width() will not
                            //             pic_real_height = this.height; // work for in memory images.
                            //             $('#affiliatepromotion-width').val(pic_real_width);
                            //             $('#affiliatepromotion-height').val(pic_real_height);
                            //         });
                            // }
            ...
            createItem: function(file){
                ...
                var item = $('<li>', {"class": "upload-kit-item done"})
                    ...
                    .append($('<input/>', {"name": name + '[type]', "value": $type, "type":"hidden"}))
